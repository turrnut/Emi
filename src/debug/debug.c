...
static int constantInstruction(const char* name, IR* chunk,
                               int offset) {
...
static int invokeInstruction(const char* name, IR* chunk,
                                int offset) {
  uint8_t constant = chunk->code[offset + 1];
...
static int byteInstruction(const char* name, IR* chunk,
                           int offset) {
